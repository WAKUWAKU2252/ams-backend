-- ═══════════════════════════════════════════════════════════════════════════
-- 0024 — รองรับบริษัท SAP ตัวที่สาม: MIG (ชื่อฐานอยู่ใน company.sapDbName ไม่ hardcode)
--
...
--
-- ยืนยันด้วยเหตุผลเดียวกับ 0021: ก่อนหน้านี้ AMS ต่อฐาน SAP ของ UBA ฐานเดียวมาตลอด
-- และ department ถูก import จาก docs/department-sap.csv ซึ่งเป็นชุดของ UBA ล้วน
--
-- ── employee.ownerCodeMig ─────────────────────────────────────────────────
--
-- คอลัมน์ที่สามต่อจาก ownerCodeUba/ownerCodeUbp — ฝั่ง SAP ของ MIG เก็บเลขนี้ในช่อง
