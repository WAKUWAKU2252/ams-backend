...
// ═══════════════════════════════════════════════════════════════════════════
import { pgTable, serial, varchar, date, uuid, integer, numeric, foreignKey, index, uniqueIndex, unique, primaryKey } from 'drizzle-orm/pg-core';
...
export const grpoLine = pgTable(
  'grpo_line',
  {
    ...
    // numeric ด้วยเหตุผลเดียวกับ purchase_order_item.quantity (PDN1.Quantity = numeric(19,6))
